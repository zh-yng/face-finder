# Local Face Clustering Engine

Privacy-first face indexing for a local photo library. Runs entirely in
Docker on your machine. No photo, thumbnail, or embedding ever leaves the
container.
...
* A local folder of photos you want indexed.
...
## 2. Point it at your photo folder
...
Either way, this mount is read-only (`:ro`) — the engine cannot modify,
...
## 6. Manage identified people

* **Open a person** — click their card to see every photo they appear in.
* **Name them** — type a name in the field at the top of their gallery,
  click **Save name**.
